...
// Single source of truth for guide slugs — keeps the sitemap in sync with the
// pages generated by app/[locale]/guide/[slug]. Previously hardcoded here and
// drifted (heic-complete-guide / blog-image-optimization were missing).
